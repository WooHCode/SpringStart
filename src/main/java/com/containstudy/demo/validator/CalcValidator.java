package com.containstudy.demo.validator;

import com.containstudy.demo.form.CalcForm;
    ...
    public void validate(Object target, Errors errors){
        ...
        if (form.getLeftNum() != null && form.getRightNum() != null){
            ...
            if (!((form.getLeftNum() % 2 ==1) && (form.getRightNum() % 2 ==0))){
                //에러인 경우에는 Errors 인터페이스의 reject 메서드에 에러 메세지의 키를 지정합니다.
                errors.reject("com.containstudy.demo.validator.CalcValidator.message");
            }
        }
    }
}
